...
class ArticleBodyCell: UICollectionViewCell {
    ...
    fileprivate func setupViews() {
        ...
        paragraphLabel.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor, centerX: nil, centerY: nil, paddingTop: 0, paddingLeft: 20, paddingBottom: 0, paddingRight: 20, width: 0, height: 0, xPadding: 0, yPadding: 0)
    }
